...
**W09 authorized-read foundation:** 8 database integration cases and 3 component cases now cover storage locator pairing, authorized short-lived grants, visibility/path checks, UI loading/retry and migration compatibility. The private bucket, upload-intent writes, actual provider behavior and independent QA are still open.
