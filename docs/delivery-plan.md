...
|---|---|---|---|
| Phase P00 foundation/auth/build | In progress; local gates and latest hosted CI run pass | 232 local tests, typecheck, production build, clean lint, proxy/safe-return-path/logout/draft-cleanup/error-message regressions, local browser evidence B06–B09; GitHub Actions run 36126641556 passed on `6cfdf55` | Verify deliberate workflow failure propagation, expiry/provider-error recovery, deployed callback and independent QA |
